...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const createNewPasswordForm = document.querySelector("#createNewPassword");
    ...
    document.querySelector("#linkCreateNewPassword").addEventListener("click", e => {
        e.preventDefault();
        forgotPasswordForm.classList.add("form--hidden");
        createNewPasswordForm.classList.remove("form--hidden");
    });
